...
import (
	...
	giladv1alpha1 "github.com/hw-operator/pkg/apis/gilad/v1alpha1"
...
var log = logf.Log.WithName("controller_giladhelloworld")

const hwFinalizer = "finalizer.gilad.hw.okto.io"
...
// Add creates a new GiladHelloWorld Controller and adds it to the Manager. The Manager will set fields on the Controller
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileGiladHelloWorld{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}

// add adds a new Controller to mgr with r as the reconcile.Reconciler
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	// Create a new controller
	c, err := controller.New("giladhelloworld-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}

	// Watch for changes to primary resource GiladHelloWorld
	err = c.Watch(&source.Kind{Type: &giladv1alpha1.GiladHelloWorld{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &giladv1alpha1.GiladHelloWorld{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileGiladHelloWorld) manageDeployment(hw *giladv1alpha1.GiladHelloWorld, reqLogger logr.Logger) (*reconcile.Result, error) {
...
func (r *ReconcileGiladHelloWorld) manageRoute(hw *giladv1alpha1.GiladHelloWorld, reqLogger logr.Logger) (*reconcile.Result, error) {
	...
	if err != nil && errors.IsNotFound(err) {
		err := r.routeForWebServer(hw, route)
		if err != nil {
			reqLogger.Error(err, "error getting server route")
			return &reconcile.Result{}, err
		}
		reqLogger.Info("Creating a new route.", "Route.Namespace", route.Namespace, "Router.Name", route.Name)
		err = r.client.Create(context.TODO(), route)
		if err != nil {
			reqLogger.Error(err, "Failed to create new Server Route.", "Route.Namespace", route.Namespace, "Route.Name", route.Name)
			return &reconcile.Result{}, err
		}
		return &reconcile.Result{Requeue: true}, nil
	} else if err != nil {
...
func (r *ReconcileGiladHelloWorld) manageService(hw *giladv1alpha1.GiladHelloWorld, reqLogger logr.Logger) (*reconcile.Result, error) {
...
func (r *ReconcileGiladHelloWorld) manageConfigMap(hw *giladv1alpha1.GiladHelloWorld, reqLogger logr.Logger) (*reconcile.Result, error) {
	cm := &corev1.ConfigMap{}
...
func (r *ReconcileGiladHelloWorld) deploymentForWebServer(hw *giladv1alpha1.GiladHelloWorld, deployment *appsv1.Deployment) error {
	var replicas int32
	replicas = 1
	...
	deployment.Spec.Selector = selecor
	deployment.Spec.Template.ObjectMeta.Name = hw.Name
...
func (r *ReconcileGiladHelloWorld) serviceForWebServer(hw *giladv1alpha1.GiladHelloWorld, service *corev1.Service) error {
	labels := map[string]string{
		"app": hw.Name,
	}
...
func (r *ReconcileGiladHelloWorld) routeForWebServer(hw *giladv1alpha1.GiladHelloWorld, route *routev1.Route) error {
	labels := map[string]string{
		"app": hw.Name,
	}
	...
	route.ObjectMeta.Name = hw.Name
	route.ObjectMeta.Namespace = hw.Namespace
...
func (r *ReconcileGiladHelloWorld) configMapForWebServer(hw *giladv1alpha1.GiladHelloWorld) (*corev1.ConfigMap, error) {
	labels := map[string]string{
		"app": hw.Name,
	}
	cm := &corev1.ConfigMap{
...
func (r *ReconcileGiladHelloWorld) syncConfigMapForWebServer(hw *giladv1alpha1.GiladHelloWorld, cm *corev1.ConfigMap) (syncRequired bool, err error) {
...
// blank assignment to verify that ReconcileGiladHelloWorld implements reconcile.Reconciler
var _ reconcile.Reconciler = &ReconcileGiladHelloWorld{}

// ReconcileGiladHelloWorld reconciles a GiladHelloWorld object
type ReconcileGiladHelloWorld struct {
...
// Reconcile reads that state of the cluster for a GiladHelloWorld object and makes changes based on the state read
// and what is in the GiladHelloWorld.Spec
// TODO(user): Modify this Reconcile function to implement your Controller logic.  This example creates
// a Pod as an example
// Note:
// The Controller will requeue the Request to be processed again if the returned error is non-nil or
// Result.Requeue is true, otherwise upon completion it will remove the work from the queue.
func (r *ReconcileGiladHelloWorld) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	reqLogger := log.WithValues("Request.Namespace", request.Namespace, "Request.Name", request.Name)
	reqLogger.Info("Reconciling HelloWorld")

	// Fetch the HelloWorld instance
	hw := &giladv1alpha1.GiladHelloWorld{}
...
func (r *ReconcileGiladHelloWorld) initFinalization(hw *giladv1alpha1.GiladHelloWorld, reqLogger logr.Logger) error {
...
func (r *ReconcileGiladHelloWorld) finalizeHw(hw *giladv1alpha1.GiladHelloWorld, reqLogger logr.Logger) error {
	...
	channelID, timestamp, err := api.PostMessage("CTKNSUATX", slack.MsgOptionAttachments(attachment))
	if err != nil {
...
func (r *ReconcileGiladHelloWorld) addFinalizer(hw *giladv1alpha1.GiladHelloWorld, reqLogger logr.Logger) error {
